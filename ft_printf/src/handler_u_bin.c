...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/12/12 20:10:55 by aamadori          #+#    #+#             */
/*   Updated: 2019/06/06 15:40:17 by aamadori         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_string			*h_u_bin(const t_conv *conv, va_list *ap)
{
	...
	ret->buff = u_base_conv(conv, arg, g_bin_base, min_digits);
	...
	if (ret->buff && ret->size)
		ret->buff = string_add(conv->flags.uppercase ? "0B" : "0b", ret->buff);
	ret->size = -1;
